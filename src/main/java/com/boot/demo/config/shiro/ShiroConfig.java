...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
		...
		List<com.boot.demo.entity.Resource> list = resourceService.findAll();
		for (com.boot.demo.entity.Resource resource : list) {
			filterChainDefinitionMap.put(resource.getUrl(), "perms[" + resource.getSourceKey() + "]");
		}
...
//		filterChainDefinitionMap.put("/admin/resource/deleteBatch", "perms[system:resource:deleteBatch]");
	...
	@Bean
	public AuthorizationAttributeSourceAdvisor authorizationAttributeSourceAdvisor(@Qualifier("myRealm")MyRealm myRealm) {
		SecurityManager manager= securityManager(myRealm);
